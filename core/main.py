...
# Aggiungi le directory al PYTHONPATH
core_dir = Path(__file__).parent
sys.path.append(str(core_dir))
sys.path.append(str(core_dir / 'scrapers'))
sys.path.append(str(core_dir / 'validators'))

from scrapers.camera_scraper import CameraScraper
from scrapers.difesa_scraper import DifesaScraper
from scrapers.eeas_scraper import EEASScraper
from scrapers.esteri_scraper import EsteriScraper
from scrapers.nato_scraper import NATOScraper
from scrapers.senato_scraper import SenatoScraper
from scrapers.un_scraper import UNScraper
