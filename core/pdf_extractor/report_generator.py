...
class AdvancedReportGenerator:
    ...
    def generate_comprehensive_report(self, extraction_results: List[Dict],
        ...
        main_report = self._generate_main_html_report(reports, analysis, output_path, extraction_results)
    ...
    def _generate_main_html_report(self, reports: Dict, analysis: Dict, output_path: Path, results: List[Dict] | None = None) -> str:
        """Generate main HTML report"""
        html_content = f"""
        <!DOCTYPE html>
        <html lang="it">
