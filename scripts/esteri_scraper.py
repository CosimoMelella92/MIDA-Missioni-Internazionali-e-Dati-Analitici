...
class EsteriScraper(WebScraper):
    ...
    def estrai_dati(self) -> pd.DataFrame:
        ...
        try:
            ...
            self.logger.error(f"Errore generale nell'estrazione dati dal Ministero degli Esteri: {str(e)}")
